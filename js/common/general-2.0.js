        ...
        fn:{
            imgLoadError:function(obj,relative_path){             //默认图片
                ...
                if(times<=2){
                    ...
                    var _src=a.def.img[_key] || a.def.img["general"];
            ...
            cutByWidth:function(str,wid,font_size){               //通过宽度截取字符串
                var a=this,nstr="";
                if(typeof str==="string" && wid>0){
                    
                    var default_ele_width=a.textSize({"fontsize":nfs},"...");
                    var nfs=font_size!==undefined?font_size:14,
                    ...
                    function recursionFunc(keys){
                        ...
                        if(nw>limit_val){
                            ...
                            if(nw<=limit_val && nw+default_ele_width>limit_val){
                                if(is_length==true){
                                    recursionFunc(nkey);
                                }else{
                                    nstr=keys;
            ...
            textSize:function(style_parameter,text) {               // 通过元素获取文字宽高
                var a=this;
            ...
                span.style.visibility = "hidden";
                var fontsize=style_parameter.fontsize || 14;
                var letter_spc=style_parameter.letter_spc!=undefined?style_parameter.letter_spc:0;
                span.style.cssText="font-size:"+fontsize+"px;line-height:1em;display:inline;padding:0;margin:0;border:none;letter-spacing:"+letter_spc+"px";
